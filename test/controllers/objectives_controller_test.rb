...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference("Objective.count") do
      post objectives_url, params: { objective: { deadline: @objective.deadline, description: @objective.description, objective: @objective.objective } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { deadline: @objective.deadline, description: @objective.description, objective: @objective.objective } }
