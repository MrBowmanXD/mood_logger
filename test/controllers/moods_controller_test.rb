...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference("Mood.count") do
      post moods_url, params: { mood: { emotion: @mood.emotion, intensity: @mood.intensity, notes: @mood.notes } }
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { emotion: @mood.emotion, intensity: @mood.intensity, notes: @mood.notes } }
