class ObjectivesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @objective.update(objective_params)
        format.html { redirect_to @objective, notice: "Objective was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to objectives_path, notice: "Objective was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_objective
      @objective = Objective.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def objective_params
      params.expect(objective: [ :objective, :description, :deadline ])
    end
end
