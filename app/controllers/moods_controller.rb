class MoodsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @mood.update(mood_params)
        format.html { redirect_to @mood, notice: "Mood was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to moods_path, notice: "Mood was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_mood
      @mood = Mood.find(params.expect(:id))
    end
